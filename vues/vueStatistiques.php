<div class="wrapper content-stats">
    ...
    <div class="add-service">
        ...
        <p>
            <?php foreach ($ListeEnfant as $liste) { ?>
                <li> <?= $liste["NomEnf"] ?> <?= $liste["PrenomEnf"]?> : <?= $liste["NomE"]?> </li>
            <?php } ?>
        </p>
    </div>
    ...
    <div class="add-service">
        ...
        <p>
            <?php foreach ($cantine as $cant) { ?>
                <li> <?= $cant["NomEnf"] ?> <?= $cant["PrenomEnf"]?> : <?= $cant["NomCantine"]?> </li>
            <?php } ?>
        </p>
    </div>
